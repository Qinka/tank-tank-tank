...
fn spawn_enemy(commands: &mut Commands) {
    ...
    let spawn_positions = vec![
        Vec2::new(rng.gen_range(-MAP_HALF_WIDTH..MAP_HALF_WIDTH), MAP_HALF_HEIGHT - 50.0),
        Vec2::new(rng.gen_range(-MAP_HALF_WIDTH..MAP_HALF_WIDTH), -MAP_HALF_HEIGHT + 50.0),
        Vec2::new(MAP_HALF_WIDTH - 50.0, rng.gen_range(-MAP_HALF_HEIGHT..MAP_HALF_HEIGHT)),
        Vec2::new(-MAP_HALF_WIDTH + 50.0, rng.gen_range(-MAP_HALF_HEIGHT..MAP_HALF_HEIGHT)),
    ];
...
fn shoot_at_player(
    ...
    commands.spawn((
        ...
        Velocity::new(direction.x * BULLET_SPEED * 0.8, direction.y * BULLET_SPEED * 0.8),
